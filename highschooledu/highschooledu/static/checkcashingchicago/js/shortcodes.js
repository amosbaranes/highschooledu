...
(function($)
{
	...
	$.AviaMapsAPI.apiFiles = 
	{
		loading: false, 
		finished: false, 
		src: 'https://web.archive.org/web/20180817113954/https://maps.googleapis.com/maps/api/js?v=3.6&sensor=false&callback=aviaOnGoogleMapsLoaded' 
	}
...
(function($)
{
    ...
    {
    	youtube : {loaded: false, src: 'https://web.archive.org/web/20180817113954/https://www.youtube.com/iframe_api' }
    }
...
/*
     FILE ARCHIVED ON 11:39:54 Aug 17, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 12:00:48 Jun 17, 2021.
...
/*
playback timings (ms):
  captures_list: 383.816
  exclusion.robots: 0.693
  exclusion.robots.policy: 0.663
